...
export function FeatureCards() {
  return (
    <section className="relative bg-[#FAFAFA] pb-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-5xl grid gap-6 md:grid-cols-2 lg:gap-8 -mt-8 relative z-10">
          {/* Card 1 */}
          <div className="flex flex-col bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100 transition-transform hover:-translate-y-1 hover:shadow-2xl hover:shadow-green-500/10 duration-300">
